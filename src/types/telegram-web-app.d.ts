...
export declare namespace TelegramWebApps {
  ...
  interface WebApp {
     ...
     */
    onEvent(eventType: EventType, eventHandler: (event: any) => void): void;

    /**
     * 	A method that deletes a previously set event handler.
     */
    offEvent(eventType: EventType, eventHandler: (event: any) => void): void;
  ...
  interface MainButton {
     ...
     */
    onClick(callback: (event: any) => void): MainButton;
